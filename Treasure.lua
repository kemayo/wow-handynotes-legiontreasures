...
ns.points = {
    ...
    ["Azsuna"] = {
        ...
        [53834053] = {quest=42284, currency=ARTIFACT, label="Small Treasure Chest", note="Inside the Academy"},
        [54313633] = {quest=42287, currency=ARTIFACT, label="Small Treasure Chest"},
        [54403490] = {quest=42285, currency=ARTIFACT, label="Small Treasure Chest", note="Inside the Academy"},
        ...
        [55621855] = {quest=40711, currency=ARTIFACT, label="Treasure Chest", note="Ley Portal inside tower"},
        [55905690] = {quest=38365, currency=ARTIFACT, label="Disputed Treasure"},
        [56443481] = {quest=38251, currency=ARTIFACT, item=132950, label="Treasure Chest"},
    ...
    ["Stormheim"] = {
        ...
        [32742791] = {quest=38490, currency=ARTIFACT, label="Treasure Chest", note="Cave entrance @ 33.6, 27.3"},
        [33143607] = {quest=38495, currency=ARTIFACT, label="Treasure Chest"},
        [35033660] = {quest=38487, currency=ARTIFACT, label="Treasure Chest", note="Cave entrance @ 34.8, 34.2"},
        [35176898] = {quest=38478, currency=ARTIFACT, label="Small Treasure Chest"},
        [35735415] = {quest=38677, currency=ARTIFACT, item=140310, label="Treasure Chest", note="On the wrecked ship"},
        [35924792] = {quest=38680, currency=ARTIFACT, label="Small Treasure Chest"},
        [37183865] = {quest=43208, currency=ARTIFACT, label="Small Treasure Chest"},
        [39486518] = {quest=38486, currency=ARTIFACT, label="Treasure Chest"},
        [39571934] = {quest=38498, currency=ARTIFACT, label="Small Treasure Chest"},
        [40656852] = {quest=38475, currency=ARTIFACT, label="Small Treasure Chest"},
        [41744604] = {quest=38488, currency=ARTIFACT, label="Small Treasure Chest"},
        [42336112] = {quest=38477, currency=ARTIFACT, label="Small Treasure Chest"},
        [42473407] = {quest=43189, currency=ARTIFACT, label="Treasure Chest", note="Entrance @ 42.2, 34.9"},
        [42616579] = {quest=38474, currency=ARTIFACT, label="Treasure Chest"},
        [43164049] = {quest=43238, currency=ARTIFACT, label="Small Treasure Chest"},
        [43708009] = {quest=43239, currency=ARTIFACT, label="Small Treasure Chest"},
        [44166997] = {quest=38489, currency=ARTIFACT, label="Small Treasure Chest"},
        [44983823] = {quest=43240, currency=ARTIFACT, label="Small Treasure Chest"},
        [46606496] = {quest=38681, currency=ARTIFACT, label="Small Treasure Chest", note="Cave entrance @ 48.2, 65.2"},
        [46768040] = {quest=38481, currency=ARTIFACT, label="Treasure Chest", note="Cave entrance @ 48.2, 65.2"},
        [47463412] = {quest=43255, currency=ARTIFACT, label="Small Treasure Chest"},
        [47986237] = {quest=38738, currency=ARTIFACT, label="Treasure Chest"},
        [48137421] = {quest=38476, currency=ARTIFACT, label="Small Treasure Chest"},
        [49085999] = {quest=43207, currency=ARTIFACT, label="Small Treasure Chest"},
        [49694731] = {quest=38763, currency=ARTIFACT, label="Glimmering Treasure Chest", note="Guarded by Vault Keepers"},
        [49777801] = {quest=38485, currency=ARTIFACT, label="Small Treasure Chest", note="Requires: Stormforged Grapple Launcher"},
        [50061816] = {quest=43195, currency=ARTIFACT, label="Treasure Chest"},
        [50314100] = {quest=38483, currency=ARTIFACT, label="Small Treasure Chest"},
        [50554125] = {quest=43246, currency=ARTIFACT, label="Small Treasure Chest"},
        [52018058] = {quest=38480, currency=ARTIFACT, label="Small Treasure Chest", note="Requires: Stormforged Grapple Launcher"},
        [53229314] = {quest=43190, currency=ARTIFACT, label="Small Treasure Chest"},
        ...
        [58044751] = {quest=40082, currency=ARTIFACT, label="Small Treasure Chest"},
        [59305846] = {quest=40088, currency=ARTIFACT, label="Treasure Chest"},
        ...
        [61836289] = {quest=40089, currency=ARTIFACT, label="Treasure Chest"},
        [61933255] = {quest=38744, currency=ARTIFACT, label="Small Treasure Chest"},
        [62667362] = {quest=40091, currency=ARTIFACT, label="Small Treasure Chest"},
        [64293956] = {quest=43302, currency=ARTIFACT, label="Small Treasure Chest"},
        ...
        [68462959] = {quest=40108, currency=ARTIFACT, label="Treasure Chest"},
        [68974183] = {quest=40086, currency=ARTIFACT, label="Small Treasure Chest"},
        [69144478] = {quest=38637, currency=ARTIFACT, label="Small Treasure Chest"},
        [69986719] = {quest=43188, currency=ARTIFACT, label="Small Treasure Chest"},
        [71924425] = {quest=43305, currency=ARTIFACT, label="Small Treasure Chest"},
        [72135489] = {quest=42628, currency=ARTIFACT, label="Small Treasure Chest"},
        [73154570] = {quest=43194, currency=ARTIFACT, label="Small Treasure Chest"},
        [73334150] = {quest=40085, currency=ARTIFACT, label="Small Treasure Chest"},
        [73965223] = {quest=42632, currency=ARTIFACT, label="Small Treasure Chest"},
        [73975858] = {quest=43237, currency=ARTIFACT, label="Small Treasure Chest"},
        [74414182] = {quest=43306, currency=ARTIFACT, label="Small Treasure Chest"},
        [75164949] = {quest=42629, currency=ARTIFACT, label="Treasure Chest", note="On top of the mast"},
        [75676060] = {quest=43304, currency=ARTIFACT, label="Small Treasure Chest"},
        [78427138] = {quest=43307, currency=ARTIFACT, label="Treasure Chest", note="*Really* requires the Stormforged Grapple Launcher"},
        [81876750] = {quest=40099, currency=ARTIFACT, label="Treasure Chest"},
        [82405451] = {quest=43191, currency=ARTIFACT, label="Small Treasure Chest"},
    },
    ["Suramar"] = {
        [16602974] = {quest=43846, currency=ARTIFACT, label="Small Treasure Chest"},
        [17275462] = {quest=43844, currency=ARTIFACT, label="Treasure Chest"},
        ...
        [26831696] = {quest=43847, currency=ARTIFACT, label="Small Treasure Chest"},
        [26877073] = {quest=43987, item=140327, label="Kyrtos's Research Notes", note="Cave entrance @ 27.3, 72.9"},
        [29271622] = {quest=43848, item=138783, label="Treasure Chest"},
        [29768817] = {quest=43748, item=141655, label="Shimmering Ancient Mana Cluster"},
        [31956249] = {quest=43831, currency=ARTIFACT, label="Small Treasure Chest"},
        ...
        [42051968] = {quest=43849, item=139786, label="Glimmering Treasure Chest"},
        [42577668] = {quest=43870, currency=ARTIFACT, label="Small Treasure Chest", note="Upstairs"},
        [44053194] = {quest=43856, item=139786, label="Glimmering Treasure Chest", note="Cave entrance behind waterfall @ 42.2, 30.0"},
        [44302289] = {quest=43850, currency=ARTIFACT, label="Treasure Chest"},
        [44387587] = {quest=43869, currency=ARTIFACT, label="Small Treasure Chest"},
        ...
        [48957379] = {quest=43867, currency=ARTIFACT, label="Treasure Chest", note="Upstairs"},
        [49988493] = {quest=43864, currency=ARTIFACT, label="Small Treasure Chest", note="Grapple from 50.0, 84.5"},
        [50068061] = {quest=44325, currency=ARTIFACT, label="Treasure Chest", note="Upstairs"},
        [51503859] = {quest=43855, currency=ARTIFACT, label="Small Treasure Chest"},
        [51908214] = {quest=43868, currency=ARTIFACT, label="Treasure Chest"},
        [52733130] = {quest=40767, currency=ARTIFACT, label="Dusty Coffer"},
        [54326033] = {quest=43875, currency=ARTIFACT, label="Treasure Chest"},
        [55685480] = {quest=43871, currency=ARTIFACT, label="Small Treasure Chest"},
        [57326039] = {quest=43873, currency=ARTIFACT, label="Treasure Chest"},
        [57686197] = {quest=43874, currency=ARTIFACT, label="Treasure Chest"},
        [60356851] = {quest=43876, item=139786, label="Glimmering Treasure Chest"},
        [61365550] = {quest=43872, currency=ARTIFACT, label="Treasure Chest"},
        [67315511] = {quest=43858, currency=ARTIFACT, label="Treasure Chest"},
        [79647289] = {quest=43741, item=141655, label="Shimmering Ancient Mana Cluster"},
        [83126933] = {quest=43863, currency=ARTIFACT, label="Treasure Chest"},
        [83975764] = {quest=43862, currency=ARTIFACT, label="Treasure Chest"},
    },
    ["Valsharah"] = {
        ...
        [43397589] = {quest=38366, currency=ARTIFACT, label="Small Treasure Chest"},
        ...
        [62076737] = {quest=39071, currency=ARTIFACT, label="Treasure Chest", note="Chest behind waterfall"},
        ...
        [63007700] = {quest=39070, currency=ARTIFACT, label="Small Treasure Chest", note="Inside Den of Claws, entrance @ 62.2, 76.2"},
    ...
    ["ThunderTotem"] = { -- Highmountain
        ...
        [32354174] = {quest=40475, currency=ARTIFACT, label="Small Treasure Chest", note="On a boat"},
        [31843842] = {quest=44352, currency=ARTIFACT, label="Treasure Chest", note="Underwater cave, below the boat"},
    },
    ...
    ["NarthalasAcademy"] = { -- Suramar
        ...
        [53633986] = {quest=42284, currency=ARTIFACT, label="Small Treasure Chest"},
