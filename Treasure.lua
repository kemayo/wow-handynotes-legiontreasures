...
ns.RegisterPoints(630, { -- Azsuna
    ...
    [49384536] = {quest=37828, --[[currency=ARTIFACT,]] loot={122681}, label=CHEST},
    [49415800] = {quest=38370, --[[currency=ARTIFACT,]] loot={141882}, label=CHEST},
    [49653448] = {quest=37831, --[[currency=ARTIFACT,]] label=CHEST_SM},
    [50215029] = {quest=42290, --[[currency=ARTIFACT,]] label=CHEST_SM},
    [50465211] = {quest=44081, --[[currency=ARTIFACT,]] loot={140685}, label="Treacherous Stallions", note="Ley Portal @ 60.3, 46.3; kill the stallions"},
    ...
    [56443481] = {quest=38251, --[[currency=ARTIFACT,]] loot={132950}, label=CHEST},
...
ns.RegisterPoints(650, { -- Highmountain
    ...
    [39704830] = {quest=39494, --[[currency=ARTIFACT,]] loot={131763}, label="Floating Treasure", note="On river surface, moves"},
    ...
    [46302760] = {quest=44280, loot={131753}, label=CHEST},
    ...
    [47644406] = {quest=39503, loot={131926}, label=CHEST, note="1/4 of slow fall toy", toy=true},
    [49647128] = {quest=39606, --[[currency=ARTIFACT,]] label=CHEST_GLIM, note="Inside cave"},
    [49653772] = {quest=39466, loot={131927}, label=CHEST, note="1/4 of slow fall toy, in nest at top of mountain", toy=true},
    ...
    [52305141] = {quest=39766, loot={131802}, label="Totally Safe Treasure Chest"},
    ...
    [53615103] = {quest=39824, loot={131810}, label=CHEST, note="1/4 of slow fall toy; on ledge, path to southeast", toy=true},
...
ns.RegisterPoints(634, { -- Stormheim
    ...
    [35735415] = {quest=38677, --[[currency=ARTIFACT,]] loot={140310}, label=CHEST, note="On the wrecked ship"},
    ...
    [42473407] = {quest=43189, --[[currency=ARTIFACT,]] loot={141896}, label=CHEST_GLIM, note="Entrance @ 42.2, 34.9"},
    [42203490] = path(43189),
    ...
    [49694731] = {quest=38763, --[[currency=ARTIFACT,]] loot={132897}, label=CHEST_GLIM, note="Guarded by Vault Keepers"},
...
ns.RegisterPoints(680, { -- Suramar
    ...
    [42051968] = {quest=43849, loot={139786}, label=CHEST_GLIM},
    [42577668] = {quest=43870, --[[currency=ARTIFACT,]] label=CHEST_SM, note="Upstairs"},
    [44053194] = {quest=43856, loot={139786}, label=CHEST_GLIM, note="Cave entrance behind waterfall @ 42.2, 30.0"},
    [42203000] = path(43856),
    ...
    [60356851] = {quest=43876, loot={139786}, label=CHEST_GLIM},
...
ns.RegisterPoints(641, { -- Val'sharah
    ...
    [44358257] = {quest=38387, --[[currency=ARTIFACT,]] loot={141892}, label=CHEST, note="Cave under the inn; entrance behind the building"},
    ...
    [50907700] = path(38388),
    [54003489] = {quest=38390, loot={141891}, --[[currency=ARTIFACT,]] label=CHEST_GLIM, note="Cave entrance @ 53.2, 38.0"},
    [53203800] = path(38390),
    ...
    [54506048] = {quest=39097, --[[currency=ARTIFACT,]] loot={130152}, label=CHEST, note="In cave"},
    ...
    [55557762] = {quest=38466, loot={130147}, toy=true, label="Unguarded Thistlemaw Treasure", note="Unguarded..."},
...
ns.RegisterPoints(830, { -- Krokuun
    ...
    [62803730] = {quest=nil, currency=ARGUNITE, loot={151246}, note="Climb up behind the tower", achievement=12074, criteria=37593}, -- Legion Tower Chest
...
ns.RegisterPoints(882, { -- MacAree
    ...
    [50605600] = {quest=48371, label="Ancient Eredar Cache", junk=true, loot={153334}, currency=ARGUNITE},
...
ns.RegisterPoints(627, { -- Dalaran
    ...
    [38102920] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
    [42104440] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
    [41005320] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
    [46205390] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
    [49406940] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
    [51706220] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
    [54505320] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
    [54304080] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
    [47702920] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
    [44601820] = {quest=46952, loot={147420}, note="Show to Dog in your Draenor garrison", hide_before=30526},
})
...
ns.RegisterPoints(633, { -- TempleofaThousandLights, Azsuna
})
...
ns.RegisterPoints(672, { -- Mardum the Shattered Abyss
    [23065389] = {quest=40797, loot={129210}, label=CHEST_SM, note="Cave entrance @ 23.6, 54.2"},
    [23605420] = path(40797),
    [34857020] = {quest=39970, loot={129210}, label=CHEST_SM},
    [41763761] = {quest=40759, loot={129196}, label=CHEST_SM},
    [42194916] = {quest=40223, loot={129210}, label=CHEST_SM},
    [45017785] = {quest=39971, loot={129192}, label=CHEST_SM},
    [51135079] = {quest=40743, loot={129210}, label=CHEST_SM},
    [63702360] = {quest=40772, loot={129210}, label=CHEST_SM}, -- in soul engine
    [66922767] = {quest=39974, loot={129210}, label=CHEST_SM},
    [69704240] = {quest=39976, loot={129210}, label=CHEST_SM},
    [73494892] = {quest=39975, loot={129195}, label=CHEST_SM},
    [74285453] = {quest=39977, loot={129210}, label=CHEST_SM, note="Cave entrance @ 70.7, 54.0"},
    [70705400] = path(39977),
    [76243899] = {quest=40338, loot={129210}, label=CHEST_SM},
    [78755047] = {quest=40274, loot={129210}, label=CHEST_SM},
    [82075043] = {quest=40820, loot={129196}, label=CHEST_SM},
})
ns.RegisterPoints(673, { -- Cryptic Hollow, Mardum
    [48761530] = {quest=39972, loot={129196}, label=CHEST_SM},
    [54855845] = {quest=39973, loot={128946}, label=CHEST_SM},
})
ns.RegisterPoints(674, { -- Soul Engine, Lower, Mardum
    [46803320] = {quest=40772, loot={129210}, label=CHEST_SM},
})
ns.RegisterPoints(675, {-- Soul Engine, Upper, Mardum
    [49844883] = {quest=40772, loot={129210}, label=CHEST_SM},
})
ns.RegisterPoints(677, { -- Illidari Ward, Vault of the Wardens
    [58693475] = {quest=40909, loot={129210}, label=CHEST_SM},
    [47325464] = {quest=40910, loot={129210}, label=CHEST_SM},
})
ns.RegisterPoints(678, { -- Vault of the Wardens
    [32104817] = {quest=40911, loot={129196}, label=CHEST_SM},
    [41506361] = {quest=40914, loot={129196}, label=CHEST_SM},
    [56994013] = {quest=40913, loot={129210}, label=CHEST_SM},
    [41413287] = {quest=40912, loot={129210}, label=CHEST_SM},
})
ns.RegisterPoints(679, { -- Warden's Court, Vault of the Wardens
    [24421005] = {quest=40915, loot={129210}, label=CHEST_SM},
    [23268157] = {quest=40916, loot={129210}, label=CHEST_SM},
})
